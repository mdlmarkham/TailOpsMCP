...
async def example_custom_configuration():
    ...
    print(f"  Max concurrent probes: {updated_config['limits']['max_concurrent_probes']}")
...
async def example_node_probing():
    ...
    if probe_result["system_info"].get("parsed"):
        ...
        print(f"  Docker: {'installed' if system_info.get('docker', {}).get('installed') else 'not installed'}")
