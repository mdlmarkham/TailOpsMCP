...
def validate_security_models():
    ...
    try:
        from src.models.security_models import (
            SecurityOperation, IdentityContext, SecurityAlert,
            InitiatorType, RiskLevel, AlertSeverity, AlertType
        )
...
def generate_validation_report(results):
    ...
    if passed_tests == total_tests:
        ...
        print(f"   The TailOpsMCP Security Framework is fully operational.")
        print(f"   Enterprise-grade security capabilities are ready for deployment.")
    else:
        print(f"\n⚠️  SOME TESTS FAILED")
        print(f"   Please review the failed components and fix issues before deployment.")
