...
class TestPolicyGateBasic:
    ...
    def setup_method(self):
        ...
        self.target_registry = Mock(spec=TargetRegistryFixtures.create_mock_target_registry)
    ...
    def test_authorize_write_operation_with_permission(self):
        ...
        write_claims = TokenClaims(
            agent="test-user",
            scopes=[Scope.CONTAINER_WRITE.value]
        )
    ...
    def test_dry_run_mode(self):
        ...
        AuthorizationAssertions.assert_authorized(result, expected_requires_approval=True)
...
class TestPolicyGateMock:
    ...
    def test_approval_required_policy_gate(self):
        ...
        AuthorizationAssertions.assert_authorized(readonly_result, expected_requires_approval=False)
        
        # Test write operation (should require approval)
        write_result = policy_gate.authorize_operation(
            "start_container", target, claims, {}
        )
        AuthorizationAssertions.assert_authorized(write_result, expected_requires_approval=True)
...
class TestPolicyGateEdgeCases:
    ...
    def test_authorize_unknown_tool(self):
        ...
        result = policy_gate.authorize_operation(
            "unknown_tool_123", target, claims, {}
        )
...
class TestPolicyGateIntegration:
    ...
    def test_integration_with_audit_logger(self):
        ...
        policy_gate.authorize_operation(
            "get_container_status", target, claims, {}
        )
...
class TestPolicyGatePerformance:
    ...
    def test_authorization_performance(self):
        ...
        assert authorization_time < 0.001, f"Authorization time {authorization_time}s exceeds threshold"
    ...
    def test_concurrent_authorization(self):
        ...
        assert total_time < 1.0, f"Concurrent authorization time {total_time}s exceeds threshold"


# Parameterized tests for different operation tiers
@pytest.mark.parametrize("operation_tier,expected_requires_approval", [
