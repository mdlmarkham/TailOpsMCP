...
class TestTargetRegistry:
    ...
    def test_load_valid_configuration(self):
        ...
        registry = TargetRegistryFixtures.create_target_registry_with_config(
            TEST_TARGETS_CONFIG
        )
    ...
    def test_reload_configuration(self):
        ...
        updated_registry = TargetRegistryFixtures.create_target_registry_with_config(
            updated_config
        )
...
def basic_target_registry():
    ...
    return TargetRegistryFixtures.create_target_registry_with_config(
        TEST_TARGETS_CONFIG
    )
...
@pytest.mark.parametrize(
    "target_id,expected_type,expected_executor",
    [
...
def test_target_types(
    basic_target_registry, target_id, expected_type, expected_executor
):
