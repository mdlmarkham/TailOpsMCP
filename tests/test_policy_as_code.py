...
class TestPolicyAsCodeIntegration:
    ...
    def test_audit_logger_initialization(self):
        ...
        assert (
            self.integration.audit_logger.log_path.exists()
            or not self.integration.audit_logger.log_path.exists()
...
class TestPolicyAsCodeManager:
    ...
    def test_default_deny_rule(self):
        ...
        has_default_deny = any(
            rule.name == "default_deny" for rule in self.manager.config.rules
        )
