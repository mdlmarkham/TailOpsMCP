...
from src.services.policy_gate import PolicyGate, OperationTier, ValidationMode, PolicyRule, PolicyConfig
...
class TestPolicyGate:
    ...
    def test_validate_parameters_success(self):
        ...
        errors = self.policy_gate.validate_parameters("test_operation", parameters, constraints)
