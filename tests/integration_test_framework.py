...
from src.services.executor import Executor, ExecutionResult
...
from tests.test_utils import ExecutionAssertions, AuthorizationAssertions
...
class IntegrationTestFramework:
    ...
    def register_test_scenario(self, 
                             scenario_id: str,
                             description: str,
                             setup_func: Callable,
                             test_func: Callable,
    ...
    async def _execute_function(self, func: Callable, context: Dict[str, Any] = None) -> Any:
...
class EndToEndTestBuilder:
    ...
    @staticmethod
    def create_basic_operation_test(tool_name: str,
        ...
        async def setup():
            ...
            execution_service = ExecutionService(target_registry, policy_gate, audit_logger)
    ...
    @staticmethod
    def create_authorization_test(tool_name: str,
                                 target_id: str = "local-host",
                                 should_authorize: bool = True) -> Dict[str, Any]:
        ...
        async def test(context):
            ...
            if should_authorize:
                assert result["success"] is True
                AuthorizationAssertions.assert_authorized(result.get("authorization_result", {}))
            else:
                assert result["success"] is False
                AuthorizationAssertions.assert_denied(result.get("authorization_result", {}))
    ...
    @staticmethod
    def create_performance_test(tool_name: str,
                               target_id: str = "local-host",
                               operation_count: int = 10,
                               concurrent_operations: int = 3) -> Dict[str, Any]:
...
class IntegrationTestScenarios:
    ...
    def get_container_status() -> Dict[str, Any]:
        ...
        return EndToEndTestBuilder.create_basic_operation_test(
            ...
            parameters={"container_id": "test-container"}
        )
