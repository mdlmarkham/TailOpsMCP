...
class TestTOONDocument:
    ...
    def test_document_creation(self):
        ...
        doc = TOONDocument(document_type="test_document", metadata={"test": "value"})
    ...
    def test_token_estimation(self):
        ...
        doc.add_section(
            "long",
            "This is a much longer text with more content for testing token estimation",
            ContentPriority.INFO,
        )
...
class TestTOONTemplates:
    ...
    def test_content_optimization(self):
        ...
        optimized = TOONTemplates.optimize_content_for_template(
            test_content, template, 1000
        )
    ...
    def test_create_optimized_document(self):
        ...
        content = {"summary": {"status": "ok"}, "details": {"count": 42}}
...
class TestTOONLLMFormatter:
    ...
    def test_executive_summary_generation(self):
        ...
        doc.add_section(
            "fleet_summary",
            {"total_targets": 50, "healthy_targets": 45},
    ...
    def test_actionable_insights(self):
        ...
        doc.add_section(
            "recommendations",
            ["Increase monitoring frequency", "Review alert thresholds"],
            ContentPriority.IMPORTANT,
        )
        doc.add_section(
            "errors", [{"action": "Fix connection issues"}], ContentPriority.CRITICAL
        )
...
class TestTOONQualityAssurance:
    ...
    def test_quality_report_generation(self):
        ...
        doc = TOONDocument(document_type="fleet_inventory")
        doc.add_section(
            "fleet_summary", {"total_targets": 50}, ContentPriority.CRITICAL
        )
    ...
    def test_quality_level_determination(self):
        ...
        assert (
            qa._determine_quality_level(0.95, {"critical": 0}) == QualityLevel.EXCELLENT
        )
        assert qa._determine_quality_level(0.85, {"critical": 0}) == QualityLevel.GOOD
        assert (
            qa._determine_quality_level(0.70, {"critical": 0})
...
class TestTOONIntegrationScenarios:
    ...
    def test_end_to_end_fleet_analysis(self):
        ...
        # Integrate with TOON
        from src.integration.toon_system_integration import (
            integrate_fleet_inventory_toon,
        )
