...
class TestPerformance:
    ...
    async def test_fleet_scalability(self, performance_monitor):
        ...
        for target_count in target_counts:
            ...
            execution_time = performance_monitor["end_time"] - performance_monitor["start_time"]
            ...
            assert throughput > performance_monitor["resource_limits"]["min_throughput_ops_per_sec"]
    ...
    async def test_workflow_performance_under_load(self, performance_monitor):
        ...
        for concurrent_count in concurrent_workflows:
            ...
            assert total_time < concurrent_count * 0.2  # Should complete within reasonable time
    ...
    async def test_event_processing_performance(self, performance_monitor):
        ...
        for batch_size in batch_sizes:
            ...
            performance_monitor["end_time"] = time.time()
            processing_time = performance_monitor["end_time"] - performance_monitor["start_time"]
        ...
        throughput_values = [result["events_per_second"] for result in processing_results.values()]
    ...
    async def test_inventory_query_performance(self, performance_monitor):
        ...
        query_types = [
            ...
            {"type": "complex_filter", "params": {"status": "healthy", "role": "container", "services": ["nginx"]}}
        ]
        ...
        for query_spec in query_types:
            ...
            performance_monitor["end_time"] = time.time()
            query_time = performance_monitor["end_time"] - performance_monitor["start_time"]
            ...
            assert query_time < performance_monitor["resource_limits"]["max_response_time_ms"] / 1000
        ...
        assert max_query_time < avg_query_time * 3  # No query should be 3x slower than average
    ...
    async def test_concurrent_user_performance(self, performance_monitor):
        ...
        for user_count in user_counts:
            ...
            user_performance_results[user_count] = {
                ...
                "successful_authentications": sum(1 for r in results if r["auth_success"]),
            ...
            assert user_performance_results[user_count]["successful_authentications"] == user_count
            ...
            for count in insert_counts:
                ...
                for i in range(count):
                    cursor.execute('''
                        ...
                        VALUES (?, ?, ?, ?)
                    ''', (f'host-{i}', f'192.168.1.{i % 255}', 'healthy', datetime.utcnow()))
            ...
            for pool_size in pool_sizes:
                ...
                with concurrent.futures.ThreadPoolExecutor(max_workers=pool_size) as executor:
                    ...
                    for i in range(pool_size * 2):  # 2x pool size
                        future = executor.submit(lambda: conn.execute("SELECT 1").fetchone())
...
def benchmark_performance(operation_name: str, threshold_ms: float = 1000):
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            print(f"  Status: {'PASS' if execution_time_ms <= threshold_ms else 'FAIL'}")
            
            # Assert performance threshold
            assert execution_time_ms <= threshold_ms, f"Performance threshold exceeded: {execution_time_ms:.2f}ms > {threshold_ms}ms"
