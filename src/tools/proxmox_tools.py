...
class ProxmoxTools:
    ...
    async def create_ct_from_template(self, template_id: int, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Execute capability
            result = await self.capability_executor.execute_proxmox_container_create(config)
    ...
    async def start_ct(self, vmid: int, host: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_container_start(parameters)
    ...
    async def stop_ct(self, vmid: int, host: str, force: bool = False) -> Dict[str, Any]:
        """Stop container.
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_container_stop(parameters)
    ...
    async def reboot_ct(self, vmid: int, host: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_container_reboot(parameters)
    ...
    async def delete_ct(self, vmid: int, host: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_container_delete(parameters)
    ...
    async def clone_ct(self, source_vmid: int, clone_config: Dict[str, Any]) -> Dict[str, Any]:
        """Clone container.
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_container_clone(parameters)
            ...
            if result.success:
                return {
                    ...
                    "message": result.output,
                    "source_vmid": source_vmid,
                    "new_vmid": result.metadata.get("new_vmid") if result.metadata else None,
                    "task_id": result.metadata.get("task_id") if result.metadata else None
                }
            else:
                return {
    ...
    async def snapshot_ct(self, vmid: int, snapshot_name: str, host: str, 
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_snapshot_create(parameters)
    ...
    async def delete_snapshot(self, vmid: int, snapshot_name: str, host: str) -> Dict[str, Any]:
        """Delete snapshot.
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_snapshot_delete(parameters)
    ...
    async def restore_snapshot(self, vmid: int, snapshot_name: str, host: str,
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_snapshot_restore(parameters)
    ...
    async def backup_ct(self, container_id: int, backup_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.capability_executor.execute_proxmox_backup_create(parameters)
            ...
            if result.success:
                return {
                    ...
                    "message": result.output,
                    "vmid": container_id,
                    "backup_id": result.metadata.get("backup_id") if result.metadata else None,
                    "filename": result.metadata.get("filename") if result.metadata else None,
    ...
    async def update_ct_resources(self, container_id: int, resources: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await api_client.update_container_resources(container_id, resource_updates)
                ...
                "properties": {
                    ...
                    "config": {
                        ...
                        "properties": {
                            ...
                            "template": {"type": "string", "description": "Container template path"},
                            ...
                            "rootfs": {"type": "string", "description": "Root filesystem configuration"},
                            ...
                            "ssh_keys": {"type": "array", "items": {"type": "string"}, "description": "SSH public keys"}
                        },
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "clone_config": {
                        ...
                        "properties": {
                            "host": {"type": "string", "description": "Proxmox host address"},
                            "new_hostname": {"type": "string", "description": "New container hostname"},
                            "new_vmid": {"type": "integer", "description": "New VMID"},
                            "full_clone": {"type": "boolean", "description": "Full clone", "default": True}
                        },
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "backup_config": {
                        ...
                        "properties": {
                            "host": {"type": "string", "description": "Proxmox host address"},
                            "storage": {"type": "string", "description": "Storage pool for backup"},
                            "mode": {"type": "string", "enum": ["snapshot", "suspend", "stop"], "description": "Backup mode"},
                            "compress": {"type": "string", "enum": ["gzip", "lzo", "zstd"], "description": "Compression"}
                        },
