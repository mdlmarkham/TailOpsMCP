...
class CapabilityRegistry:
    ...
    def list_capabilities(self, capability_type: Optional[CapabilityType] = None) -> List[Capability]:
    ...
    def validate_capability_parameters(self, capability_name: str, parameters: Dict[str, Any]) -> List[str]:
...
class PolicyValidator:
    ...
    def _has_operation_permission(self, user_id: str, operation_type: OperationType) -> bool:
    ...
    def revoke_permission(self, user_id: str, capability_type: CapabilityType) -> None:
        ...
        """
        if user_id in self._user_permissions and capability_type.value in self._user_permissions[user_id]:
            self._user_permissions[user_id].remove(capability_type.value)
            logger.info(f"Revoked {capability_type.value} permission from user {user_id}")
...
class AuditLogger:
    ...
    def log_operation(self, operation: CapabilityOperation, result: OperationResult) -> None:
        ...
        logger.info(f"Capability Operation {status}: {operation.capability_name} on {operation.target_id} by {operation.requested_by}")
...
class CapabilityExecutor:
    ...
    async def execute_operation(self, operation: CapabilityOperation) -> OperationResult:
        ...
        try:
            ...
            capability = self.capability_registry.get_capability(operation.capability_name)
            if not capability:
    ...
    async def _execute_capability(self, capability: Capability, operation: CapabilityOperation) -> Dict[str, Any]:
    ...
    async def _execute_get_system_status(self, operation: CapabilityOperation) -> Dict[str, Any]:
    ...
    async def _execute_restart_service(self, operation: CapabilityOperation) -> Dict[str, Any]:
    ...
    async def _execute_check_service_health(self, operation: CapabilityOperation) -> Dict[str, Any]:
    ...
    async def _execute_list_containers(self, operation: CapabilityOperation) -> Dict[str, Any]:
        ...
        return {
            ...
            "result": {
                "containers": [
                    ...
                    {"id": "ghi789", "name": "cache", "status": "stopped", "image": "redis:alpine"}
                ],
                "total_count": 3,
                "running_count": 2
            }
    ...
    async def _execute_start_container(self, operation: CapabilityOperation) -> Dict[str, Any]:
    ...
    async def _execute_stop_container(self, operation: CapabilityOperation) -> Dict[str, Any]:
...
class CapabilityManager:
    ...
    def __init__(self):
        ...
        self.executor = CapabilityExecutor(self.registry, self.policy_validator, self.audit_logger)
    ...
    async def get_system_status(self, target_id: str, requested_by: str) -> Dict[str, Any]:
    ...
    async def check_service_health(self, service_name: str, target_id: str, requested_by: str) -> Dict[str, Any]:
    ...
    async def list_capabilities(self, user_id: str, capability_type: Optional[str] = None) -> Dict[str, Any]:
    ...
    def grant_user_permission(self, user_id: str, capability_type: str) -> Dict[str, Any]:
        """Grant permission to user for capability type.
...
async def restart_service(service_name: str, target_id: str, requested_by: str, **kwargs) -> Dict[str, Any]:
    """Quick service restart function."""
    manager = get_capability_manager()
    return await manager.execute_service_restart(service_name, target_id, requested_by, **kwargs)
...
async def check_service_health(service_name: str, target_id: str, requested_by: str) -> Dict[str, Any]:
