...
def is_host_allowed(host: str, allowed_hosts: Optional[List[str]] = None) -> tuple[bool, str]:
...
def is_url_allowed(url: str, allowed_hosts: Optional[List[str]] = None) -> tuple[bool, str]:
...
def is_port_allowed(port: int, allowed_ports: Optional[List[int]] = None) -> tuple[bool, str]:
