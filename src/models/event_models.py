...
class EventStatistics:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result['events_by_severity'] = {k.value: v for k, v in self.events_by_severity.items()}
        result['events_by_source'] = {k.value: v for k, v in self.events_by_source.items()}
        result['events_by_category'] = {k.value: v for k, v in self.events_by_category.items()}
...
class EventBuilder:
    ...
    @staticmethod
    def health_check(source: EventSource, target: str, status: str, details: Dict[str, Any] = None) -> SystemEvent:
    ...
    @staticmethod
    def error(source: EventSource, title: str, description: str, details: Dict[str, Any] = None) -> SystemEvent:
    ...
    @staticmethod
    def security_alert(source: EventSource, title: str, description: str, severity: EventSeverity = EventSeverity.WARNING) -> SystemEvent:
    ...
    @staticmethod
    def operation_completed(source: EventSource, operation: str, target: str = None, duration: float = None) -> SystemEvent:
