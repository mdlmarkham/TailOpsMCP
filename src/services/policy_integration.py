...
from src.services.policy_as_code import PolicyAsCodeManager, TargetConfig, PolicyRule
from src.utils.audit_enhanced import StructuredAuditLogger, AuditEventType
...
class PolicyAsCodeIntegration:
    ...
    def _register_targets_from_config(self):
        ...
        for target_config in config.targets:
            try:
                ...
                logger.info(f"Registered target from Policy-as-Code config: {target_config.id}")
    ...
    async def authorize_operation(self, 
                                ...
                                dry_run: bool = False) -> Tuple[bool, List[str], Optional[str]]:
        ...
        policy_errors = self.policy_manager.validate_operation(target_id, operation, parameters)
    ...
    async def execute_remote_operation(self,
                                     actor: str,
                                     target_id: str,
                                     operation: str,
