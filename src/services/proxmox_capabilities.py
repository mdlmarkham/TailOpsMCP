...
class ProxmoxCapabilityExecutor:
    ...
    async def execute_proxmox_container_create(
        ...
        try:
            ...
            if result.status == "created":
                return ExecutionResult(
                    ...
                    duration=0.0,
                    metadata={"vmid": result.vmid, "task_id": result.task_id},
                )
            else:
                return ExecutionResult(
    ...
    async def execute_proxmox_container_start(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
        ...
        try:
            ...
            if result.status == "started":
                return ExecutionResult(
                    ...
                    duration=0.0,
                    metadata={"vmid": vmid, "task_id": result.task_id},
                )
            else:
                return ExecutionResult(
                    status=ExecutionStatus.FAILURE,
    ...
    async def execute_proxmox_container_stop(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def execute_proxmox_container_reboot(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def execute_proxmox_container_delete(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def execute_proxmox_container_clone(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
        ...
        try:
            ...
            if api_client and await api_client.connect():
                ...
                result = await self._cli_client.clone_container_cli(
                    source_vmid, clone_config
                )
            else:
                return ExecutionResult(
                    status=ExecutionStatus.CONFIGURATION_ERROR,
    ...
    async def execute_proxmox_snapshot_create(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
        ...
        try:
            ...
            api_client = self._get_api_client(host)
            if api_client and await api_client.connect():
                result = await api_client.create_snapshot(
                    vmid, snapshot_name, description
                )
            elif self._cli_client and host == "localhost":
                result = await self._cli_client.create_snapshot_cli(
                    vmid, snapshot_name, description
                )
            else:
                return ExecutionResult(
    ...
    async def execute_proxmox_snapshot_delete(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def execute_proxmox_snapshot_restore(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
        ...
        try:
            ...
            api_client = self._get_api_client(host)
            if api_client and await api_client.connect():
                result = await api_client.restore_snapshot(
                    vmid, snapshot_name, rollback
                )
            elif self._cli_client and host == "localhost":
                result = await self._cli_client.restore_snapshot_cli(
                    vmid, snapshot_name
                )
            else:
                return ExecutionResult(
    ...
    async def execute_proxmox_backup_create(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def execute_proxmox_discover_hosts(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
        ...
        try:
            ...
            discovery = ProxmoxDiscoveryEnhanced(api_credentials=self.api_credentials)
    ...
    async def execute_proxmox_discover_containers(
        self, parameters: Dict[str, Any]
    ) -> ExecutionResult:
...
class ProxmoxCapability:
    ...
    async def create_ct_from_template(
        template_id: int, config: ContainerConfig
    ) -> OperationResult:
        ...
        try:
            ...
            return OperationResult.failure(
                "Not implemented", "Use ProxmoxCapabilityExecutor"
            )
        except Exception as e:
    ...
    @staticmethod
    async def backup_ct(
        container_id: int, backup_config: BackupConfig
    ) -> OperationResult:
        """Backup container.
    ...
    @staticmethod
    async def restore_ct(
        backup_id: str, target_config: Dict[str, Any]
    ) -> OperationResult:
