...
from src.services.policy_gate import PolicyConfig, PolicyRule, OperationTier, ValidationMode
            ...
            for param_name, constraint in rule.parameter_constraints.items():
                ...
                if "validation_type" in constraint:
                    try:
                        ...
                        errors.append(f"Invalid validation type in rule {rule.name}: {constraint['validation_type']}")
