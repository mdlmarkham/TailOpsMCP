...
class SSHTailscaleBackend(RemoteExecutionBackend):
    ...
    def is_connected(self) -> bool:
        ...
        return self.connected and self.client and self.client.get_transport().is_active()
    ...
    async def execute_capability(self, capability: OperationType, 
        ...
        try:
            ...
            # Execute command
            stdin, stdout, stderr = self.client.exec_command(command, timeout=parameters.get("timeout", 300))
            ...
            result = ExecutionResult(
                status=ExecutionStatus.SUCCESS if success else ExecutionStatus.EXECUTION_ERROR,
                success=success,
    ...
    async def _command_service_restart(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_service_start(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_service_stop(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_service_status(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_container_create(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_container_delete(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_container_start(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_container_stop(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_container_restart(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_container_inspect(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_stack_deploy(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_stack_remove(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_stack_update(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_backup_create(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_backup_restore(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_backup_list(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
        """Generate command for backup listing."""
        return "sudo vzdump --list"
    
    async def _command_backup_delete(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_snapshot_create(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_snapshot_delete(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_snapshot_restore(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_snapshot_list(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_file_read(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_file_write(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_file_delete(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_file_copy(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_network_scan(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_network_test(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_network_status(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
        """Generate command for network status."""
        return "ip addr show && ip route show"
    
    async def _command_package_update(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_package_install(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_package_remove(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
    ...
    async def _command_package_list(self, parameters: Dict[str, Any], target_info: Dict[str, Any]) -> str:
