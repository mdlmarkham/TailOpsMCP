...
class ProxmoxBackend(RemoteExecutionBackend):
    ...
    async def _handle_backup_create(
        self, parameters: Dict[str, Any], target_info: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _handle_backup_delete(
        self, parameters: Dict[str, Any], target_info: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _handle_snapshot_create(
        self, parameters: Dict[str, Any], target_info: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _handle_snapshot_delete(
        self, parameters: Dict[str, Any], target_info: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _handle_snapshot_restore(
        self, parameters: Dict[str, Any], target_info: Dict[str, Any]
    ) -> ExecutionResult:
    ...
    async def _handle_snapshot_list(
        self, parameters: Dict[str, Any], target_info: Dict[str, Any]
    ) -> ExecutionResult:
