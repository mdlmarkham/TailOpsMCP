...
class PackageManager:
    ...
    async def _apt_update_system(self, auto_approve: bool) -> Dict:
        ...
        try:
            ...
            if update_result.returncode != 0:
                return {"success": False, "error": f"apt-get update failed: {update_result.stderr}"}
            ...
            if upgrade_result.returncode != 0:
                return {"success": False, "error": f"apt-get upgrade failed: {upgrade_result.stderr}"}
            ...
            return {
                ...
                "output": upgrade_result.stdout[-500:] if len(upgrade_result.stdout) > 500 else upgrade_result.stdout
            }
    ...
    async def install_package(self, package_name: str, auto_approve: bool = False) -> Dict:
