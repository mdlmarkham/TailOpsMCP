...
from src.models.enhanced_fleet_inventory import (
    ...
    NetworkInterface, ContainerInfo
)
from src.models.inventory_snapshot import (
    InventorySnapshot, SnapshotManager, SnapshotType, SnapshotDiff, ChangeType
)
from src.utils.inventory_persistence import EnhancedInventoryPersistence
from src.services.inventory_service import InventoryService
from src.models.fleet_inventory import ProxmoxHost, Event, EventType, EventSeverity
...
class TestEnhancedInventoryModels(unittest.TestCase):
    ...
    def test_enhanced_target_creation(self):
        ...
        self.assertEqual(self.target1.security_posture.security_status, SecurityStatus.SECURE)
    ...
    def test_serialization(self):
        ...
        self.assertEqual(restored_target.resource_usage.cpu_percent, self.target1.resource_usage.cpu_percent)
...
class TestFleetInventory(unittest.TestCase):
    ...
    def test_serialization(self):
        ...
        self.assertEqual(restored_inventory.total_services, self.inventory.total_services)
...
class TestInventoryService(unittest.TestCase):
    ...
    @patch('src.services.inventory_service.InventoryService._convert_to_enhanced_inventory')
